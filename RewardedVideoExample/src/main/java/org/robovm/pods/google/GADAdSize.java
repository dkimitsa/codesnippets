...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/GADAdSize/*</name>*/ 
    ...
    public static native @ByVal GADAdSize fromCGSize(@ByVal CGSize size);
    @Bridge(symbol="GADAdSizeFullWidthPortraitWithHeight", optional=true)
    public static native @ByVal GADAdSize fullWidthPortraitWithHeight(@MachineSizedFloat double height);
    @Bridge(symbol="GADAdSizeFullWidthLandscapeWithHeight", optional=true)
    public static native @ByVal GADAdSize fullWidthLandscapeWithHeight(@MachineSizedFloat double height);
    public boolean equalToSize(GADAdSize size2) { return equalToSize(this, size2); }
    @Bridge(symbol="GADAdSizeEqualToSize", optional=true)
    private static native boolean equalToSize(@ByVal GADAdSize size1, @ByVal GADAdSize size2);
    ...
    public static native @ByVal GADAdSize fromNSValue(NSValue value);
    /*</methods>*/
}
